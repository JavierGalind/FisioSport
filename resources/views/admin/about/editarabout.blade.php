    ...
    <div class="row">
      <div class="col-md-8">
          ...
          <div class="form-group required autocomplete">
            <label>Titulo</label>
            <input type="text" name="titulo_about" value="{{$about->titulo_about}}" class="form-control" required>
          </div>
          <div class="form-group">
            <label>Descripcion</label>
            <textarea name="descripcion_about" id="editor" rows="8" cols="80" class="form-control" required>{{$about->descripcion_about}}</textarea>
          </div>
          <div class="form-group">
          ...
          <div class="form-group required autocomplete">
              ...
              <input type="text" name="titulo2_about" value="{{$about->titulo2_about}}" class="form-control" required>
          </div>
          <div class="form-group">
              <label>Descripcion del Segundo Apartado</label>
              <textarea name="descripcion2_about" id="editor1" rows="8" cols="80" class="form-control" required>{{$about->descripcion2_about}}</textarea>
          </div>
          <div class="form-group">
